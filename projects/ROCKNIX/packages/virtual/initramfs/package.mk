...
PKG_URL=""
PKG_DEPENDS_TARGET="libc:init glibc:init busybox:init util-linux:init e2fsprogs:init dosfstools:init spleen-font:init avfs:init ${SPLASH_PACKAGE:-rocknix-splash}:init"
PKG_SECTION="virtual"
